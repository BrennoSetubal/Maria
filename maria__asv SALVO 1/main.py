...
with sr.Microphone() as mic:
    while True:
        ...
        try:
            ...
            if texto.lower() == 'abrir google' or texto.lower() == 'abra o google' or texto.lower() == 'maria abri o google':
                google()

            if texto.lower() == 'abrir chat gpt' or texto.lower() == 'abra o chat gpt' or texto.lower() == 'maria abri o chat gpt':
                chat_gpt()
            ...
            if texto.lower()== 'abrir youtube' or texto.lower() == 'abra o youtube' or texto.lower() == 'maria abri o youtube' or texto.lower() == 'ok maria abri o youtube':
                youtube()

            if texto.lower() == 'fechar a aba atual':
                pyautogui.hotkey('ctrl', 'w')

            elif texto.lower == 'feixar' or texto.lower() == 'dispensada' or texto.lower() == 'encerrar' or texto.lower() == 'fechar':
                falar('encerrando...')
                falar('e até a próxima')
                break
